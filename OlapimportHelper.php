 ...
 */
  ...
  * @license http://opensource.org/licenses/gpl-license.php GNU General Public License (GPL)
  */
class OlapimportHelper extends OntoWiki_Component_Helper
{
    ...
    {
        if ($event->isModel) {
            $url = new OntoWiki_Url(array('controller' => 'olapimport'), array());
            $menu = $event->menu;
            $menu->appendEntry('Import OLAP Data', (string) $url);
        }
    }
}
